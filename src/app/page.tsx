        ...
        <div className={styles.page}>
            <section className={styles.page__section}>
                ...
                <div className={styles.page__section__banner}>
                    <img src="https://www.apple.com/v/services/h/images/services/chapternav/dark/apple_one_dark__eu2pb1ea55g2_large.svg" alt="" className={styles.img} />
            ...
            <section className={styles.page__section}>
                    ...
                    <div className="absolute bottom-0 flex flex-col items-start justify-end w-[1000px] h-[828px] pb-16">
                        <div className="flex items-center w-full mb-[6px] gap-3">
                            ...
                            <Badge className="flex items-center text-[10px]">
                                <img src="https://www.apple.com/v/services/h/images/services/chapternav/dark/apple_one_dark__eu2pb1ea55g2_large.svg" alt="" className="w-fit h-8 -mt-3 mr-1" />
                                번들에 포함
                            </Badge>
                        </div>
                ...
                {/* 이미지 슬라이드 */}
                <div className={`${styles.slider} mt-7 my-40 w-full`}>
            ...
            <section className={styles.page__section}>
                <img src="/assets/icons/apple-one-dark.jpg" alt="" />
                <img src="/assets/icons/apple-services-icons.png" alt="" />
                <div className="flex flex-col items-center">
                    <span className="text-[22px] font-bold">4가지 Apple 서비스를</span>
